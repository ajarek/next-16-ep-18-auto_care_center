    ...
    <section className='w-full flex flex-col items-center justify-center   md:p-16 p-4 gap-4'>
      <div className='w-full flex flex-col items-center gap-6 px-8'>
        ...
        <p className='max-w-xl text-center text-xl'>
          Od rutynowej konserwacji po skomplikowane naprawy – zapewniamy
          kompleksowe rozwiązania dla wszystkich potrzeb Twojego pojazdu
        </p>
      </div>
        ...
        {carCareData.map((care) => (
          <Card key={care.id} className='w-full bg-secondary-foreground'>
            <CardHeader className='relative p-0 overflow-hidden'>
              ...
              <span className='absolute top-4 left-4 bg-primary p-2 rounded-full text-primary-foreground text-2xl font-bold'>
                {care.icon}
              </span>
            </CardHeader>
            <CardContent>
